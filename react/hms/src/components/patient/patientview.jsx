                        ...
                        <>
                            ...
                            <div className="pv-summary-header">
                                <div className="pv-header-content">
                                    ...
                                    {/* Right — Edit + Vitals 2x2 + Diagnosis/Barriers */}
                                    <div className="pv-header-right">
                                        <button className="pv-edit-btn" onClick={() => {
                                            console.log('📝 [PatientView] Edit button clicked — opening internal edit modal');
                                            setShowEditModal(true);
                                        }}>
                                            <MdEdit size={14} /> Edit
                                        </button>

                                        {/* Vitals — 2x2 Grid identical to AppointmentViewModal */}
                                        <div className="pv-vitals-grid-2x2">
                                            ...
                                            <div className="pv-metric-card pv-metric-bp">
                                                <span className="pv-metric-val">{patientData.bp} <small>mmHg</small></span>
