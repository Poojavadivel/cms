/**
 * PathologistSettings.jsx
 * Pathologist settings page matching Flutter's PathologistSettingsScreen
 */
...
const PathologistSettings = () => {
  ...
  return (
    <div className="pathologist-settings">
          ...
          <div className="profile-content">
            ...
            <div className="profile-info-grid">
              <InfoItem
                icon={<MdPerson />}
                label="Full Name"
                value={user?.fullName || 'Pathologist Name'}
              />
              <InfoItem
                icon={<MdEmail />}
                label="Email"
                value={user?.email || 'pathologist@hms.com'}
              />
              <InfoItem
                icon={<MdPhone />}
                label="Phone"
            ...
            <div className="notification-options">
              <div className="notification-item">
                <div className="notification-info">
                  ...
                  <p>Receive test request updates via email</p>
                </div>
                <button
              ...
              <div className="notification-item">
                <div className="notification-info">
                  ...
                  <p>Receive real-time alerts for new lab requests</p>
                </div>
                <button
