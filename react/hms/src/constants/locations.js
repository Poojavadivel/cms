/**
 * Comprehensive Indian Location Data (States and Districts)
 */
...
export const LOCATION_DATA = {
    ...
    "Himachal Pradesh": [
        "Bilaspur", "Chamba", "Hamirpur", "Kangra", "Kinnoaur", "Kullu", "Lahaul & Spiti", "Mandi", "Shimla", "Sirmaur (Sirmour)", "Solan", "Una"
    ],
    "Jammu and Kashmir": [
...
export const STATES = Object.keys(LOCATION_DATA).sort();

// Comprehensive Pincode mapping is now lazy-loaded from pincode_mapping.json
